...
.popover-content .acount_list .btn{
...
<li  ><a href="cart/signin.php">Cart <span class="badge"><?php if($total!=0){echo $total;}else{ echo "0";} ?></span></a></li>
<?php 
}else{
...
content:' <div class="row acount_list">'+
  '<div class="col-xs-12">'+
 ...
 ' <ul class="list-unstyled">'+
  ...
  '<li><a href="whisky/whisky.php">All Whisky Departments</a></li>'+
