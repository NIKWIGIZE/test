...
function dimple_image2($product_image,$product_name,$actual_price,$discount_price,$size,$id){
  ...
  <!--Different images of product-->
   <img class="img-responsive imageStyle" src="../images/zoom/z1.jpg" alt="">
	 <img class="img-responsive imageStyle" src="../images/zoom/z9.jpg" alt="">
    <img class="img-responsive imageStyle" src="../images/zoom/z10.jpg" alt="">
	 <img class="img-responsive imageStyle" src="../images/zoom/z5.jpg" alt="">
	 </div>
  </div>
...
<button id="add" class="btn btn-warning btn-block" type="submit" name="mycart"> <span class="glyphicon glyphicon-shopping-cart "></span>&nbsp;Add to Cart</button>
...
<!--Different images of product each represent specific size-->
   <img id="home_image"class="img-responsive imageStyle" src="../images/zoom/z2.jpg" alt="">
	 <img id="second_page"class="img-responsive imageStyle " src="../images/zoom/z10.jpg" alt="">
    <img id="third_image"class="img-responsive imageStyle " src="../images/zoom/z7.jpg" alt="">
	<img id="forth_image"class="img-responsive imageStyle " src="../images/zoom/z1.jpg" alt="">
	 <img id="fith_image"class="img-responsive imageStyle " src="../images/zoom/z8.jpg" alt="">
	 </div>
</div>
</div>
<br>
