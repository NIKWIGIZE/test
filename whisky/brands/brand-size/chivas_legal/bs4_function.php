...
function dimple_image2($product_image,$product_name,$actual_price,$discount_price,$size,$id){
  ...
  <!--Different images of product-->
   <img class="img-responsive imageStyle" src="images/thumbnail/z1.jpg" alt="">
...
<!--Different images of product each represent specific size-->
   <img id="home_image"class="img-responsive imageStyle" src="images/thumbnail/z2.jpg" alt="">
	 <img id="second_page"class="img-responsive imageStyle " src="images/thumbnail/z10.jpg" alt="">
    <img id="third_image"class="img-responsive imageStyle " src="images/thumbnail/z7.jpg" alt="">
	<img id="forth_image"class="img-responsive imageStyle " src="images/thumbnail/z1.jpg" alt="">
	 <img id="firth_image"class="img-responsive imageStyle " src="images/thumbnail/z8.jpg" alt="">
	 </div>
</div>
</div>
<br>
