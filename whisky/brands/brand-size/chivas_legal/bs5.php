...
<html lang="en">
 ...
 //Get id of chivas loaded from ajax and fetch result based on that id
 ...
 if(isset($_POST['cataloge'])){
	...
	product_cataloge=? ")or die($conn->error);
...
/*NAVIGATE THROUGH PAGES USING AJAX*/

//load back to home page when first image is clicked 
...
//load second page when user click on second image
...
//load forth page when user click on forth image

$("#forth_image").click(function(){
	
//alert('working');
var cataloge='cl003';
$.post('brand-size/chivas_legal/bs4.php',{cataloge},function(data){
