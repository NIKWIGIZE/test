...
function dimple_image2($product_image,$product_name,$actual_price,$discount_price,$size,$id){
  ...
  <!--Different images of product-->
   <img class="img-responsive imageStyle" src="../../images/thumbnail/z8.jpg" alt="">
...
<!--Different images of product each represent specific size-->
   <img id="home_page"class="img-responsive imageStyle " src="../../images/thumbnail/z12.jpg" alt="">
    ...
    <img id="third_page"class="img-responsive imageStyle " src="../../images/thumbnail/z6.jpg" alt="">
	 <img id="forth_image" class="img-responsive imageStyle " src="../../images/thumbnail/z8.jpg" alt="">
	 </div>
</div>
</div>
<br>
