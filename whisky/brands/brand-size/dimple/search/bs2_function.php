...
<!--Different images of product each represent specific size-->
   <img id="home_image"class="img-responsive imageStyle " src="../../images/thumbnail/z12.jpg" alt="">
	 <img id="image7"class="img-responsive imageStyle " src="../../images/thumbnail/z7.jpg" alt="">
