...
while($row=$result->fetch_assoc()){
	...
	dimple_image($row['product_image'],$row['product_name'],$row['actual_price'],
...
//load the second page's image when user click second image;
...
//load the third page's image when user click third image;
